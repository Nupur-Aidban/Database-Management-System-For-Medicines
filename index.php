          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex  flex-column flex-lg-row align-items-center w-100 justify-content-between">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item"> -->
                <a class="nav-link" href="index.php"> Online Buy </a>
                </li>
                <!-- <li class="nav-item">
              ...
              <!-- </div>
              <button type="submit" name="Send" id="Send" class="" value="Send">Search
              </button>
              </div> -->
              ...
              <div class="row">
                ...
                <div class="col-md-8">
                  <div class="detail-box">
                    ...
                    <p>So it be the work of a moment.</p><br>
                    <p>Trusted by so many customers.</p>
                    </p>
                    <div>
                      <a href="login.php">
                      Online Buy
      ...
      <div class="feature_container">
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
              Provides fast delivery at your doorsteps!!
            </p>
          </div>
        </div>
        <div class="box">
 ...
 -->
  ...
  <section class="about_section layout_padding">
    <div class="container">
      ...
      <div class="detail-box">
        <p>
          We are so excited to finally be able to share our beautiful website with all of you.
          We have been working on it for months,and we hope that you like it as much as we do.
          <br>
        <p> Want to check it out ?</p>
        <p> Go to the link in our bio!</p>
        </p>
        <!-- <div class="d-flex justify-content-center">
          <a href="">
            Read More
      ...
      <div class="row">
        ...
        <div class="col-md-7">
          <div class="detail-box">
            ...
            <p>
              Now! <br>
            <p>Get medicines easily at your doorstep ,24/7 available on our website </p><br>
            Trusted by so many customers.
            </p>
          </div>
        </div>
        ...
        <div class="col-md-3">
          <div class="info_menu">
            ...
            <ul class="navbar-nav  ">
              ...
              <li class="nav-item">
                <a class="nav-link" href="buy.php"> Info </a>
              </li>
            </ul>
          </div>
        </div>
        <div class="col-md-6">
          <div class="info_news">
            ...
            <input type="text" name="Email" placeholder="Enter Your email">
              ...
              <button type="submit" name="Send" id="Send" class="" value="Send">Subscribe
              </button>
              </div>
            </form>
          </div>
